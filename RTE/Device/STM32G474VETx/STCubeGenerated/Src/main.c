...
static void MX_TIM1_Init(void)
{
  ...
  htim1.Instance = TIM1;
  htim1.Init.Prescaler = TIM1PSC-1;
  htim1.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim1.Init.Period = TIM1CLK/TIM1PSC/ExtADCSampleRate-1;
...
static void MX_TIM3_Init(void)
{
  ...
  htim3.Instance = TIM3;
  htim3.Init.Prescaler = TIM3PSC-1;
  htim3.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim3.Init.Period = TIM3CLK/(TIM3PSC)/ADC5SampleRate-1;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, Shk_Pin|MagV_Pin|SenV_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ARM_RESET_GPIO_Port, ARM_RESET_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, ADC1_CS_Pin|ADC2_CS_Pin|ADC3_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, BAT1SW_Pin|BAT2SW_Pin|SPI1_SCK_Pin|SPI1_MOSI_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, PULSE_Pin|MagGainZ_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, MagGainX_Pin|MagGainY_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED_R_Pin|LED_G_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : Shk_Pin MagV_Pin SenV_Pin */
  GPIO_InitStruct.Pin = Shk_Pin|MagV_Pin|SenV_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : ADC1_CS_Pin ADC2_CS_Pin ADC3_CS_Pin */
  GPIO_InitStruct.Pin = ADC1_CS_Pin|ADC2_CS_Pin|ADC3_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : BAT1SW_Pin BAT2SW_Pin */
  GPIO_InitStruct.Pin = BAT1SW_Pin|BAT2SW_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : SPI1_MISO_Pin bUSBPlug_Pin */
  GPIO_InitStruct.Pin = SPI1_MISO_Pin|bUSBPlug_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : FLOW_Pin */
  GPIO_InitStruct.Pin = FLOW_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(FLOW_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : GR_Pin */
  GPIO_InitStruct.Pin = GR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GR_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : PULSE_Pin LED_R_Pin LED_G_Pin */
  GPIO_InitStruct.Pin = PULSE_Pin|LED_R_Pin|LED_G_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : MagGainX_Pin MagGainY_Pin */
  GPIO_InitStruct.Pin = MagGainX_Pin|MagGainY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : MagGainZ_Pin */
  GPIO_InitStruct.Pin = MagGainZ_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
  HAL_GPIO_Init(MagGainZ_GPIO_Port, &GPIO_InitStruct);
...
static void PVD_Config(void)
{
  ...
  sConfigPVD.PVDLevel = PWR_PVDLEVEL_5;//2.8V
  sConfigPVD.Mode = PWR_PVD_MODE_IT_RISING;//when power off and below 2.8V
