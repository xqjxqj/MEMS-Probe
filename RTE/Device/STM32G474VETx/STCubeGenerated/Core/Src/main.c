...
static void MX_ADC5_Init(void)
{
  ...
  hadc5.Init.ExternalTrigConv = ADC_EXTERNALTRIG_T3_CC1;
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, MAG_X_DIN_Pin | MAG_Y_DIN_Pin | MAG_Z_DIN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(PULSE_CPU_GPIO_Port, PULSE_CPU_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, SENS_Power_Pin | Mag_Power_Pin | SHK_Power_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, LED_R_Pin | LED_G_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : MAG_X_DOUT_Pin MAG_Y_DOUT_Pin MAG_Z_DOUT_Pin */
  GPIO_InitStruct.Pin = MAG_X_DOUT_Pin | MAG_Y_DOUT_Pin | MAG_Z_DOUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : MAG_X_DIN_Pin MAG_Y_DIN_Pin MAG_Z_DIN_Pin */
  GPIO_InitStruct.Pin = MAG_X_DIN_Pin | MAG_Y_DIN_Pin | MAG_Z_DIN_Pin;
  ...
  /*Configure GPIO pins : FLOW_CPU_Pin GR_CPU_Pin */
  GPIO_InitStruct.Pin = FLOW_CPU_Pin | GR_CPU_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : PULSE_CPU_Pin */
  GPIO_InitStruct.Pin = PULSE_CPU_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(PULSE_CPU_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : SENS_Power_Pin Mag_Power_Pin SHK_Power_Pin */
  GPIO_InitStruct.Pin = SENS_Power_Pin | Mag_Power_Pin | SHK_Power_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
