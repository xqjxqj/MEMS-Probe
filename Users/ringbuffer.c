...
// __INLINE 
unsigned short rt_ringbuffer_get_size(struct rt_ringbuffer *rb)
{
                        ...
                        unsigned short size)
{
    ...
    rb->buffer_ptr = pool;
    rb->buffer_size = size; // RT_ALIGN_DOWN(size, RT_ALIGN_SIZE);
}
 ...
 */
unsigned short rt_ringbuffer_put(struct rt_ringbuffer *rb,
                                 unsigned char *ptr,
 ...
 */
unsigned short rt_ringbuffer_put_force(struct rt_ringbuffer *rb,
                                         unsigned char *ptr,
                                       unsigned short length)
{
 ...
 */
unsigned short rt_ringbuffer_get(struct rt_ringbuffer *rb,
                                 unsigned char *ptr,
                                 unsigned short length)
{
    unsigned short size;
...
struct rt_ringbuffer *rt_ringbuffer_create(unsigned short size)
{
