...
/*! \page stm32f3_usbd CMSIS-Driver USBD Setup
...
The STM32CubeMX configuration for STMicroelectronics STM32373C-EVAL Board with steps for Pinout, Clock, and System Configuration are 
...
-----------------
  1. Under Connectivity open \b USB Configuration:
     ...
     - <b>NVIC Settings</b>: enable interrupts
          ...
          :-----------------------------------------|:--------|:--------------------|:--------------
          USB high priority global interrupt        | \b ON   | 0                   | 0
          USB low priority global interrupt         | \b ON   | 0                   | 0
...
#include "USBD_STM32G4xx.h"


#ifndef USBD_MAX_ENDPOINT_NUM
#define USBD_MAX_ENDPOINT_NUM          (7U)
#endif
...
#define USBD_EP7_RX_RAM_SIZE           (64U)
#endif
#ifndef USBD_EP7_TX_BUF_KIND
#define USBD_EP7_TX_BUF_KIND           (0U)
#endif
#ifndef USBD_EP7_TX_RAM_SIZE
#define USBD_EP7_TX_RAM_SIZE           (64U)
#endif

#ifndef USBD_EP8_RX_BUF_KIND
#define USBD_EP8_RX_BUF_KIND           (0U)
#endif
#ifndef USBD_EP8_RX_RAM_SIZE
#define USBD_EP8_RX_RAM_SIZE           (64U)
#endif
#ifndef USBD_EP8_TX_BUF_KIND
#define USBD_EP8_TX_BUF_KIND           (0U)
#endif
#ifndef USBD_EP8_TX_RAM_SIZE
#define USBD_EP8_TX_RAM_SIZE           (64U)
#endif
...
for (i = 0U; i < ((USBD_MAX_ENDPOINT_NUM + 1U) * 2U); i++) {
    if (ep[i].max_packet_size != 0U) {
      if ((i & 1) == 0U) {      // If OUT endpoint
        (void)HAL_PCD_EP_Close(hpcd,  i >> 1);
      } else {                  // If IN  endpoint
        (void)HAL_PCD_EP_Close(hpcd, (i >> 1) | 0x80U);
      }
    }
  }
